          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <h1 className="text-5xl lg:text-7xl font-light text-gray-900 mb-8 leading-tight">
                Test WebGen Full
                <span className="block text-primary font-medium mt-2">Tech</span>
              </h1>
            </motion.div>
            ...
            >
              Test complet du système WebGen AI
            </motion.p>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-light mb-4">Test WebGen Full</h2>
            <p className="text-gray-400 mb-8">Tech</p>
            <div className="pt-8 border-t border-gray-800">
              <p className="text-gray-500">&copy; 2025 Test WebGen Full. Tous droits réservés.</p>
            </div>
          </div>
        </div>
      </footer>
